          ...
          <div className="py-12 lg:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-white leading-relaxed max-w-xs">
                A diversified industrial group delivering excellence in manufacturing,
                infrastructure, energy, and engineering across the globe.
              </p>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-xs uppercase tracking-[0.25em] text-white mb-4">
                Quick Links
              </h4>
              <ul className="space-y-2.5">
                {navLinks.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-sm text-white hover:text-gold-400 transition-colors duration-300 flex items-center gap-2 group/link"
                    >
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-sm text-white hover:text-white transition-colors">
            ...
            <div>
              ...
              <div className="mt-6">
                <p className="text-xs text-white tracking-[0.15em] mb-2">
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 px-3 py-2 text-sm bg-white/5 border border-white rounded-l-xl text-white/60 placeholder-white/20 focus:border-gold-400/50 focus:outline-none transition-all"
                  />
                  <button className="px-4 py-2 bg-gradient-to-r from-[#F28C28] to-[#F28C28] text-white text-xs font-semibold rounded-r-xl hover:shadow-lg hover:shadow-[#F28C28]/50 transition-all">
                    Subscribe
                  </button>
                </div>
              </div>
